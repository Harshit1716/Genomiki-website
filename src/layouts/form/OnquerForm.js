...
import { userOnquer1 } from "store/tableData/onquer";
...
function Form() {
  ...
  const validateForm = () => {
    ...
    if (!form.sequencingPlatform)
      errors.sequencingPlatform = "Sequencing Platform is required";
                      ...
                      >
                        ...
                        <MDBox mb={2}>
                          <MDTypography variant="body2" fontWeight="bold">
                            {product == "Onquer" ? "Project ID*" : "Sample ID*"}
                          </MDTypography>
                          <input
                            type="text"
                            name="sampleId"
                      ...
                      >
                              ...
                              >
                                ...
                                <MDBox>
                                  <MDButton
                                    ...
                                    variant="text"
                                    onClick={() =>
                                      handleRemoveFile(idx, setmetaDataFiles)
                                    }
                                  >
                                    Cancel
                                  </MDButton>
                        ...
                        >
                          <input
                            ...
                            style={{ display: "none" }}
                            onChange={(e) =>
                              handleFileChange(e, setmetaDataFiles)
                            }
                          />
                          <MDBox
                            display="flex"
